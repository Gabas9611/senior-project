...
createApp({
    setup() {
        ...
        const boxes = ref([
            { title:'單車',
              text: 
              '從大智北一街左轉至大智北路，右轉進新民街，右轉進入復興路四段，左轉進入復興東路，右轉進入樂業路，左轉進入祥順路一段，向右轉進入新平路一段，向左轉進入環太東路，向右轉進入大源三十二街，向左轉進入大源路，向右轉進入中山路二段477巷186弄，向右轉進入明秀西路，向左轉進入明秀南路，右轉即可到達目的地。耗時29min。'
            },
            {  title:'241公車',
