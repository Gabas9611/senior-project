...
const app = createApp({
    setup() {
        ...
        const isInteractionDisabled = ref(false); // New: Flag to disable interaction
        ...
        const updateLayout = (index) => {
            if (isInteractionDisabled.value) {
                return; // If interaction is disabled, do nothing
            }

            centerIndex.value = index;
            isInteractionDisabled.value = true; // Disable interaction
            setTimeout(() => {
                isInteractionDisabled.value = false; // Re-enable interaction after 1 second
        ...
        const getStyle = (i) => {
            ...
            const maxAllowedOffset = getMaxAllowedOffset();
